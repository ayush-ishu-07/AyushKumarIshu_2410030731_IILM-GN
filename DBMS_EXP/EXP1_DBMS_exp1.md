...
## Step 7: Insert Data into Tables Department
```sql
...
```
## Step 8: Insert Data into Table Employee
```sql
...
WHERE DEPTNO = 20;
```
## Query 4: Modify SAL Column Size
```sql
